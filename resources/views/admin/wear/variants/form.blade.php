...
<div class="grid gap-5 md:grid-cols-2">
    ...
    <div><label class="field-label">SKU</label><input class="field font-mono" name="sku" value="{{ old('sku', $variant->sku) }}" maxlength="80" pattern="[A-Za-z0-9][A-Za-z0-9._-]*" required><p class="mt-1 text-xs text-black">Letters, numbers, dots, underscores and hyphens.</p></div>
...
<div class="flex gap-3 pt-2">
    ...
    <a href="{{ route('admin.wear.products.variants.index', $product) }}" class="rounded-xl border border-black px-4 py-3 text-sm font-semibold hover:bg-white">Cancel</a>
</div>
