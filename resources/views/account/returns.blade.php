        ...
        <div data-returns-page>
            <div class="flex flex-col gap-3 border-b border-gray-200 pb-6 sm:flex-row sm:items-end sm:justify-between">
                <div>
                    ...
                    <h1 class="mt-2 text-2xl font-bold tracking-tight text-gray-900 sm:text-3xl">Returns &amp; support</h1>
                    <p class="mt-2 text-sm text-gray-500">Request a return or exchange, or get help with an order.</p>
                </div>
                <button data-new-request type="button" class="button-dark inline-flex items-center justify-center gap-2 rounded-full px-5">
            ...
            <div data-returns-list class="mt-6 space-y-3">
                ...
                <div class="rounded-2xl border border-gray-200 bg-white p-5 shadow-sm sm:p-6">
                    <div class="flex flex-wrap items-center justify-between gap-3">
                        <div>
                            <p class="text-sm font-medium text-gray-900">Return · Order #KP-000123</p>
                            <p class="mt-0.5 text-xs text-gray-500">Requested 2 days ago · 1 item</p>
                        </div>
                    ...
                    <div class="mt-4 flex items-center gap-3 border-t border-gray-100 pt-4">
                        <img src="" class="h-12 w-12 rounded-lg bg-gray-100 object-cover" alt="">
                        <div>
                            <p class="text-sm text-gray-700">Product name · Size M</p>
                            <p class="text-xs text-gray-400">Reason: Wrong size</p>
                        </div>
                    </div>
                </div>
                --}}
                ...
                <div class="flex flex-col items-start justify-between gap-4 sm:flex-row sm:items-center">
                    <div class="flex items-center gap-3">
                        <div class="flex h-10 w-10 items-center justify-center rounded-xl bg-white shadow-sm">
                            <x-tabler-headset size="18" class="text-gray-600" />
                        </div>
                        <div>
                            <p class="text-sm font-medium text-gray-900">Need help with something else?</p>
                            <p class="text-sm text-gray-500">Our team typically replies within a few hours.</p>
                        </div>
                    </div>
                    <button data-contact-support type="button" class="inline-flex items-center gap-2 rounded-full border border-gray-300 bg-white px-5 py-2.5 text-sm font-medium text-gray-700 hover:bg-gray-100">
    ...
    <div data-return-modal class="fixed inset-0 z-50 hidden items-end justify-center bg-black/40 sm:items-center">
        <div class="max-h-[90vh] w-full max-w-lg overflow-y-auto rounded-t-2xl bg-white p-6 shadow-xl sm:rounded-2xl">
            <div class="flex items-center justify-between">
                <h2 class="text-lg font-semibold text-gray-900">Request return or exchange</h2>
                <button data-close-return-modal type="button" class="text-gray-400 hover:text-gray-700">
                    <x-tabler-x size="20" />
                </button>
            </div>
            ...
            <form data-return-form class="mt-5 space-y-4">
                <div>
                    <label class="mb-1.5 block text-sm font-medium text-gray-700">Select order</label>
                ...
                <div>
                    <label class="mb-1.5 block text-sm font-medium text-gray-700">Item(s)</label>
                    <div data-return-items class="space-y-2 rounded-xl border border-gray-100 p-3 text-sm text-gray-400">
                ...
                <div>
                    ...
                    <div class="grid grid-cols-2 gap-3">
                        <label class="flex cursor-pointer items-center justify-center gap-2 rounded-xl border border-gray-200 py-2.5 text-sm font-medium text-gray-700 has-[:checked]:border-gray-900 has-[:checked]:bg-gray-900 has-[:checked]:text-white">
                ...
                <div>
                    <label class="mb-1.5 block text-sm font-medium text-gray-700">Additional details <span class="font-normal text-gray-400">(optional)</span></label>
